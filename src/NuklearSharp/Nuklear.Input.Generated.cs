...
namespace NuklearSharp
{
	public unsafe static partial class Nuklear
	{
		...
		public static int nk_input_has_mouse_click_in_rect(nk_input i, int id, Rectangle b)
		{
			nk_mouse_button* btn;
			if (i == null) return (int) (nk_false);
			btn = (nk_mouse_button*) i.mouse.buttons + id;
		...
		public static int nk_input_has_mouse_click_down_in_rect(nk_input i, int id, Rectangle b, int down)
		{
			nk_mouse_button* btn;
			if (i == null) return (int) (nk_false);
			btn = (nk_mouse_button*) i.mouse.buttons + id;
			return
				(int) (((nk_input_has_mouse_click_in_rect(i, (int) (id), (Rectangle) (b))) != 0) && ((btn->down) == (down)) ? 1 : 0);
		}

		public static int nk_input_is_mouse_click_in_rect(nk_input i, int id, Rectangle b)
		{
			nk_mouse_button* btn;
			if (i == null) return (int) (nk_false);
			btn = (nk_mouse_button*) i.mouse.buttons + id;
			return
				(int)
					((((nk_input_has_mouse_click_down_in_rect(i, (int) (id), (Rectangle) (b), (int) (nk_false))) != 0) &&
					  ((btn->clicked) != 0))
						? nk_true
						: nk_false);
		}

		public static int nk_input_is_mouse_click_down_in_rect(nk_input i, int id, Rectangle b, int down)
		{
			nk_mouse_button* btn;
			if (i == null) return (int) (nk_false);
			btn = (nk_mouse_button*) i.mouse.buttons + id;
			return
				(int)
					((((nk_input_has_mouse_click_down_in_rect(i, (int) (id), (Rectangle) (b), (int) (down))) != 0) &&
					  ((btn->clicked) != 0))
						? nk_true
						: nk_false);
		}

		public static int nk_input_any_mouse_click_in_rect(nk_input _in_, Rectangle b)
		{
			int i;
			int down = (int) (0);
			for (i = (int) (0); (i) < (NK_BUTTON_MAX); ++i)
			{
				down = (int) (((down) != 0) || ((nk_input_is_mouse_click_in_rect(_in_, (int) (i), (Rectangle) (b))) != 0) ? 1 : 0);
			}
			return (int) (down);
		}

		public static int nk_input_is_mouse_hovering_rect(nk_input i, Rectangle rect)
		{
			if (i == null) return (int) (nk_false);
		...
		public static int nk_input_is_mouse_prev_hovering_rect(nk_input i, Rectangle rect)
		{
			if (i == null) return (int) (nk_false);
		...
		public static int nk_input_mouse_clicked(nk_input i, int id, Rectangle rect)
		{
			if (i == null) return (int) (nk_false);
			if (nk_input_is_mouse_hovering_rect(i, (Rectangle) (rect)) == 0) return (int) (nk_false);
			return (int) (nk_input_is_mouse_click_in_rect(i, (int) (id), (Rectangle) (rect)));
		}
		...
		public static int nk_toggle_behavior(nk_input _in_, Rectangle select, ref uint state, int active)
		{
			...
			if ((nk_button_behavior(ref state, (Rectangle) (select), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
			{
				state = (uint) (NK_WIDGET_STATE_ACTIVE);
				active = active != 0 ? 0 : 1;
			}

			if (((state & NK_WIDGET_STATE_HOVER) != 0) && (nk_input_is_mouse_prev_hovering_rect(_in_, (Rectangle) (select)) == 0))
				state |= (uint) (NK_WIDGET_STATE_ENTERED);
			else if ((nk_input_is_mouse_prev_hovering_rect(_in_, (Rectangle) (select))) != 0) state |= (uint) (NK_WIDGET_STATE_LEFT);
			return (int) (active);
		}
	}
}